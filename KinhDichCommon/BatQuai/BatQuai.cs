...
namespace KinhDichCommon
{
    ...
    {
        public static readonly Cung Kien = new  Cung { Id = 1, Name = "Càn", NameChinese = "", Hanh = Kim,
            Duong = true, Duong3 = true, Duong2 = true, Duong1 = true };

        public static readonly Cung Doai = new Cung { Id = 2, Name = "Đoài", NameChinese = "", Hanh = Kim,
            Duong = true, Duong3 = false, Duong2 = true, Duong1 = true };

        public static readonly Cung Ly = new Cung { Id = 3, Name = "Ly", NameChinese = "", Hanh = Hoa,
            Duong = true, Duong3 = true, Duong2 = false, Duong1 = true };

        public static readonly Cung Chan = new Cung { Id = 4, Name = "Chấn", NameChinese = "", Hanh = Moc,
            Duong = true, Duong3 = false, Duong2 = false, Duong1 = true };

        public static readonly Cung Ton = new Cung { Id = 5, Name = "Tốn", NameChinese = "", Hanh = Moc,
            Duong = false, Duong3 = true, Duong2 = true, Duong1 = false };

        public static readonly Cung Kham = new Cung { Id = 6, Name = "Khảm", NameChinese = "", Hanh = Thuy,
            Duong = false, Duong3 = false, Duong2 = true, Duong1 = false };

        public static readonly Cung Can = new Cung { Id = 7, Name = "Cấn", NameChinese = "", Hanh = Tho,
            Duong = false, Duong3 = true, Duong2 = false, Duong1 = false };

        public static readonly Cung Khon = new Cung { Id = 8, Name = "Khôn", NameChinese = "", Hanh = Tho,
